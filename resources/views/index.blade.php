            ...
            <div class="flex flex-col md:flex-row flex-1 px-2 py-6">
                ...
                <div class="w-full flex flex-col justify-between mx-2 md:mx-4">
                    ...
                    <div class="text-gray-600 mt-3 line-clamp-3">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias amet aperiam consequatur dicta
                        eaque est et, facere fugit iure maxime molestias nihil non, officia perspiciatis quam quos sint
                        tempore veniam!
                    </div>
        ...
        <div
            ...
            <div class="flex flex-col md:flex-row flex-1 px-2 py-6">
                ...
                <div class="w-full flex flex-col justify-between mx-4">
                    ...
                    <div class="text-gray-600 mt-3 line-clamp-3">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium amet blanditiis deserunt
                        dignissimos dolores eligendi inventore, libero nam natus nihil nobis non numquam optio quibusdam
                        quisquam, repellat velit vero, voluptates?
                    </div>
                    <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                        <div class="flex items-center text-xs text-gray-400 font-bold space-x-2 ">
                            <div>10 hours ago</div>
        ...
        <div
            ...
            <div class="flex flex-col md:flex-row flex-1 px-2 py-6">
                ...
                <div class="w-full flex flex-col justify-between mx-4">
                    ...
                    <div class="text-gray-600 mt-3 line-clamp-3">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium commodi cum dolor eius id
                        in itaque labore magnam, molestiae nulla quae quidem repellendus, temporibus ullam veniam
                        veritatis vitae voluptas voluptate!
                    </div>
                    <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                        <div class="flex items-center text-xs text-gray-400 font-bold space-x-2 ">
                            <div>10 hours ago</div>
