...
class SpamManagementTest extends TestCase
{
    ...
    /** @test */
    public function shows_mark_idea_as_spam_livewire_component_when_user_has_autorization()
    {
    ...
    /** @test */
    public function does_not_show_mark_idea_as_spam_livewire_component_when_user_does_not_have_autorization()
    {
        $user = User::factory()->create();
        $idea = Idea::factory()->create();
    ...
    /** @test */
    public function marking_an_idea_as_not_spam_shows_on_menu_when_user_is_admin()
    {
        $user = User::factory()->admin()->create();
        $idea = Idea::factory()->create([
            'spam_reports' => 1,
