...
class EditIdeaTest extends TestCase
{
    ...
    /** @test */
    public function shows_edit_idea_livewire_component_when_user_has_autorization()
    {
    ...
    /** @test */
    public function does_not_show_edit_idea_livewire_component_when_user_does_not_have_autorization()
    {
        $user = User::factory()->create();
        $idea = Idea::factory()->create();
    ...
    /** @test */
    public function editing_an_idea_does_not_work_when_user_does_not_have_authorization_because_idea_was_created_longer_then_an_hour_ago()
    {
        $user = User::factory()->create();
