...
class DeleteIdeaTest extends TestCase
{
    ...
    /** @test */
    public function shows_delete_idea_livewire_component_when_user_has_autorization()
    {
    ...
    /** @test */
    public function does_not_show_delete_idea_livewire_component_when_user_does_not_have_autorization()
    {
        $user = User::factory()->create();
        $idea = Idea::factory()->create();
