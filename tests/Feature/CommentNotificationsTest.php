...
class CommentNotificationsTest extends TestCase
{
    ...
    /** @test */
    public function comment_notifications_livewire_component_does_not_renders_when_user_not_logged_in()
    {
    ...
    /** @test */
    public function notification_show_for_logged_in_user()
    {
        $user = User::factory()->create();
    ...
    /** @test */
    public function notifications_idea_deleted_redirects_to_index_page()
    {
        $user = User::factory()->create();
        $idea = Idea::factory()->create([
            'user_id' => $user->id,
    ...
    /** @test */
    public function notifications_comment_deleted_redirects_to_index_page()
    {
        $user = User::factory()->create();
        $idea = Idea::factory()->create([
            'user_id' => $user->id,
