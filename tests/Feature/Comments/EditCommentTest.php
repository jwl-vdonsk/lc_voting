...
class EditCommentTest extends TestCase
{
    ...
    /** @test */
    public function shows_edit_comment_livewire_component_when_user_has_autorization()
    {
    ...
    /** @test */
    public function does_not_show_edit_comment_livewire_component_when_user_does_not_have_autorization()
    {
        $idea = Idea::factory()->create();
    ...
    public function editing_a_comment_works_when_user_has_authorization()
    {
        ...
        $this->assertEquals('First Comment', Comment::first()->body);
    }
